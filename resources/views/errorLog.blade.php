...
<body class="antialiased">
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8" style="margin-top: -25rem;">
            <div class="flex justify-center" style="margin-top: 25rem;">
            ...
            @foreach($errorlog as $logs)
            @php
            $err = json_decode($logs->error, true);
            $params_json = json_encode($err['params'], JSON_PRETTY_PRINT);
            @endphp
            <div class="mt-16">
                <div class="grid gap-6 lg:gap-8" style="width: 50rem;">
